...
const FLAVOR_IMGS = {
  mango: '/products/doypack-mango.webp?v=5',
  muz: '/products/doypack-muz.webp?v=5',
  ananas: '/products/doypack-ananas.webp?v=5',
}
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-stage" aria-hidden="true">
            ...
            <img className="hero-pack hero-pack--1" src="/products/doypack-mango.webp?v=5" alt="" />
            <img className="hero-pack hero-pack--2" src="/products/doypack-muz.webp?v=5" alt="" />
            <img className="hero-pack hero-pack--3" src="/products/doypack-ananas.webp?v=5" alt="" />
      ...
      <section className="mixbox" id="mix-kutu">
        <div className="mixbox-inner">
          <div className="mixbox-art reveal">
            <img src="/products/mix-kutu.webp?v=5" alt={t.mixbox.imgAlt} />
          </div>
          <div className="mixbox-copy reveal">
            ...
            <div className="sachet-row" aria-hidden="true">
              <img src="/products/poset-mango.webp?v=5" alt="" loading="lazy" />
              <img src="/products/poset-muz.webp?v=5" alt="" loading="lazy" />
              <img src="/products/poset-ananas.webp?v=5" alt="" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
