export const STRINGS = {
  ...
  en: {
    ...
    hero: {
      ...
      h1a: 'Peel &',
      h1b: 'Enjoy!',
      sub: ', the peelable fruit gummy candy. Mango, banana, pineapple and watermelon flavours. Peeling it is as fun as eating it!',
      ctaFlavors: 'Explore the Flavours',
      ctaMix: 'Mix Box 🎁',
      chipsAria: 'Highlights',
      chips: ['🥭 Mango', '🍌 Banana', '🍍 Pineapple', '🍉 Watermelon'],
    },
    flavors: {
      kicker: 'Our Flavours',
      h2: 'Which one will you peel first?',
      p: 'Each pack holds 55 g of pure fun. Four fruity flavours made with real fruit juice.',
      chipPack: 'Doypack',
      chipHalal: 'Halal',
      items: [
        {
